...
func FromGeographicAddress(addr *models.GeographicAddress) *GeographicAddress {
	...
	return &GeographicAddress{
		AtSchemaLocation:   addr.AtSchemaLocation,
		AtType:             addr.AtType,
		AllowsNewSite:      addr.AllowsNewSite,
		FieldedAddress:     FromFieldedAddress(addr.FieldedAddress),
		FormattedAddress:   FromFormattedAddress(addr.FormattedAddress),
		GeographicLocation: FromGeographicLocation(addr.GeographicLocation),
		HasPublicSite:      addr.HasPublicSite,
		ID:                 util.NewOrDefault(addr.ID),
		ReferencedAddress:  addr.ReferencedAddress,
	}
}
