...
type ProductOfferingQualificationFindHandlerFunc func(ProductOfferingQualificationFindParams) middleware.Responder

// Handle executing the request and returning a response
func (fn ProductOfferingQualificationFindHandlerFunc) Handle(params ProductOfferingQualificationFindParams) middleware.Responder {
	return fn(params)
}
...
type ProductOfferingQualificationFindHandler interface {
	Handle(ProductOfferingQualificationFindParams) middleware.Responder
}
