...
func (o *ProductOfferingQualificationGetURL) Build() (*url.URL, error) {
	...
	var _path = "/productOfferingQualificationManagement/v3/productOfferingQualification/{ProductOfferingQualificationId}"

	productOfferingQualificationID := o.ProductOfferingQualificationID
	if productOfferingQualificationID != "" {
		_path = strings.Replace(_path, "{ProductOfferingQualificationId}", productOfferingQualificationID, -1)
	} else {
		return nil, errors.New("productOfferingQualificationId is required on ProductOfferingQualificationGetURL")
	}
...
func (o *ProductOfferingQualificationGetURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ProductOfferingQualificationGetURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ProductOfferingQualificationGetURL")
	}
