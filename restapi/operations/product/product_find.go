...
type ProductFindHandlerFunc func(ProductFindParams) middleware.Responder

// Handle executing the request and returning a response
func (fn ProductFindHandlerFunc) Handle(params ProductFindParams) middleware.Responder {
	return fn(params)
}

// ProductFindHandler interface for that can handle valid product find params
type ProductFindHandler interface {
	Handle(ProductFindParams) middleware.Responder
}
