...
// ProductOrderCreateParams contains all the bound params for the product order create operation
...
func (o *ProductOrderCreateParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
	...
	if runtime.HasBody(r) {
		defer r.Body.Close()
		var body models.ProductOrderCreate
		if err := route.Consumer.Consume(r.Body, &body); err != nil {
			if err == io.EOF {
				res = append(res, errors.Required("productOrder", "body", ""))
			} else {
				res = append(res, errors.NewParseError("productOrder", "body", "", err))
			}
		} else {
