...
// QuoteRequestStateChangeParams contains all the bound params for the quote request state change operation
...
func (o *QuoteRequestStateChangeParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
