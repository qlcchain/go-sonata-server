...
// QuoteGetParams contains all the bound params for the quote get operation
...
func (o *QuoteGetParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
