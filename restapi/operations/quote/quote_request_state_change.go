...
type QuoteRequestStateChangeHandlerFunc func(QuoteRequestStateChangeParams) middleware.Responder

// Handle executing the request and returning a response
func (fn QuoteRequestStateChangeHandlerFunc) Handle(params QuoteRequestStateChangeParams) middleware.Responder {
	return fn(params)
}
...
type QuoteRequestStateChangeHandler interface {
	Handle(QuoteRequestStateChangeParams) middleware.Responder
}
