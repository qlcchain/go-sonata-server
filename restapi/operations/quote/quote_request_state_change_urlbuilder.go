...
func (o *QuoteRequestStateChangeURL) WithBasePath(bp string) *QuoteRequestStateChangeURL {
	o.SetBasePath(bp)
	return o
}
...
func (o *QuoteRequestStateChangeURL) Build() (*url.URL, error) {
	...
	var _path = "/quoteManagement/v2/quote/requestStateChange"
...
func (o *QuoteRequestStateChangeURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on QuoteRequestStateChangeURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on QuoteRequestStateChangeURL")
	}
