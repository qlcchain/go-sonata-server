...
// ProductOfferingQualificationManagementHubDeleteParams contains all the bound params for the product offering qualification management hub delete operation
...
func (o *ProductOfferingQualificationManagementHubDeleteParams) bindHubID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
