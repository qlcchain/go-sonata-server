...
func (o *ProductOfferingQualificationManagementHubDeleteURL) Build() (*url.URL, error) {
	...
	var _path = "/productOfferingQualificationManagement/v3/hub/{HubId}"

	hubID := o.HubID
	if hubID != "" {
		_path = strings.Replace(_path, "{HubId}", hubID, -1)
	} else {
		return nil, errors.New("hubId is required on ProductOfferingQualificationManagementHubDeleteURL")
	}
...
func (o *ProductOfferingQualificationManagementHubDeleteURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ProductOfferingQualificationManagementHubDeleteURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ProductOfferingQualificationManagementHubDeleteURL")
	}
