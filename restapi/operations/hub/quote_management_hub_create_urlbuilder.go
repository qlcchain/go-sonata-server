...
func (o *QuoteManagementHubCreateURL) Build() (*url.URL, error) {
	...
	var _path = "/quoteManagement/v2/hub"
...
func (o *QuoteManagementHubCreateURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on QuoteManagementHubCreateURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on QuoteManagementHubCreateURL")
	}
