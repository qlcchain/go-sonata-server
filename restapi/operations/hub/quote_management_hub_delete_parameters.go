...
// QuoteManagementHubDeleteParams contains all the bound params for the quote management hub delete operation
...
func (o *QuoteManagementHubDeleteParams) bindHubID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
