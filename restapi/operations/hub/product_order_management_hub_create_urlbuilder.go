...
func (o *ProductOrderManagementHubCreateURL) Build() (*url.URL, error) {
	...
	var _path = "/productOrderManagement/v3/hub"
...
func (o *ProductOrderManagementHubCreateURL) BuildFull(scheme, host string) (*url.URL, error) {
	if scheme == "" {
		return nil, errors.New("scheme is required for a full url on ProductOrderManagementHubCreateURL")
	}
	if host == "" {
		return nil, errors.New("host is required for a full url on ProductOrderManagementHubCreateURL")
	}
