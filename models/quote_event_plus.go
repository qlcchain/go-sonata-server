...
func (m *QuoteEventPlus) Event() QuoteSummaryView {
	return m.eventField
}

// SetEvent sets the event of this subtype
func (m *QuoteEventPlus) SetEvent(val QuoteSummaryView) {
	m.eventField = val
}

// EventID gets the event Id of this subtype
func (m *QuoteEventPlus) EventID() string {
	return "QuoteEventPlus"
}

// SetEventID sets the event Id of this subtype
func (m *QuoteEventPlus) SetEventID(val string) {
}

// EventTime gets the event time of this subtype
func (m *QuoteEventPlus) EventTime() *strfmt.DateTime {
	return m.eventTimeField
}

// SetEventTime sets the event time of this subtype
func (m *QuoteEventPlus) SetEventTime(val *strfmt.DateTime) {
	m.eventTimeField = val
}

// EventType gets the event type of this subtype
func (m *QuoteEventPlus) EventType() QuoteEventType {
	return m.eventTypeField
}

// SetEventType sets the event type of this subtype
func (m *QuoteEventPlus) SetEventType(val QuoteEventType) {
...
func (m *QuoteEventPlus) validateEvent(formats strfmt.Registry) error {
...
func (m *QuoteEventPlus) validateEventTime(formats strfmt.Registry) error {
...
func (m *QuoteEventPlus) validateEventType(formats strfmt.Registry) error {
