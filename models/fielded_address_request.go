...
func (m *FieldedAddressRequest) contextValidateGeographicSubAddress(ctx context.Context, formats strfmt.Registry) error {

	if m.GeographicSubAddress != nil {
		if err := m.GeographicSubAddress.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("geographicSubAddress")
			}
			return err
