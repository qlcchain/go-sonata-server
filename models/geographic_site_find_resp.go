...
func (m *GeographicSiteFindResp) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateGeographicAddress(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *GeographicSiteFindResp) contextValidateGeographicAddress(ctx context.Context, formats strfmt.Registry) error {

	if m.GeographicAddress != nil {
		if err := m.GeographicAddress.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("geographicAddress")
			}
			return err
...
func (m *GeographicSiteFindResp) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
