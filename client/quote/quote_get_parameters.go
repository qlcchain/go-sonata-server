...
// WithDefaults hydrates default values in the quote get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *QuoteGetParams) WithDefaults() *QuoteGetParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the quote get params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *QuoteGetParams) SetDefaults() {
